...
from app.core.calcs.indoor_natgas import (
    explosion_indoor,
    gas_release,
    jet_fire_stub,
    mass_calculation,
...
class IndoorNatgasScenario(BaseScenario):
    ...
    def validate(self, ctx: CalculationContext) -> None:
        ...
        if missing:
            raise ScenarioError("POUO3: отсутствуют группы входных данных: " + ", ".join(missing))


class JetFireStubScenario(BaseScenario):
    """Заглушка для раздела 8.3 templatePOUO3.docx."""

    scenario_type = "jet_fire_stub"
